...
const imageBackground =
  "https://media.gettyimages.com/photos/sharing-food-picture-id825855446?s=612x612";
...
export default class Input extends Component {
  ...
  componentDidMount = () => {
    ...
    this.setState({
      form: {
        ...this.state.form,
        firstName: this.props.location.state[0].firstName,
        phone: this.props.location.state[0].phone
      }
    });
  };
  ...
  Share = (newPost, clean) => {
    ...
    axios
      .post(`http://localhost:9000/post/post`, newPost)
      .then(res => {
